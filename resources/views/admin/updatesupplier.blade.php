        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">               
                    <form action="{{route('admin.postupdatesupplier', $supplier->id)}}" method="post" class="max-w-sm mx-auto">
                        @csrf
                        <div class="mb-5">
                        ...
                        <button type="submit" class="text-white px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200 
                            text-sm px-4 py-2.5 focus:outline-none px-4 py-2.5 focus:outline-none">Update supplier</button>
                    </form>
                </div>
            </div>
        </div>
